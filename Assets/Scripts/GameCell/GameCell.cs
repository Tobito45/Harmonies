...
namespace Harmonies.Cells
{
    public class GameCell : NetworkBehaviour
    {
        ...
        [SerializeField]
        private GameObject[] _cellTypes;

        [SerializeField]
        private GameObject _prevTypes;
        ...
        [ClientRpc]
        private void ChangeTypeClientRpc(int index)
        {
            _prevTypes.SetActive(false);
            _prevTypes = _cellTypes[index];
            _cellTypes[index].SetActive(true);
        }
